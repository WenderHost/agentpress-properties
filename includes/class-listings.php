...
class AgentPress_Listings {
	...
	function create_post_type() {
		...
		$args = apply_filters( 'agentpress_listings_post_type_args',
			array(
				'labels' => array(
					'name'               => __( 'Properties', 'agentpress-listings' ),
					'singular_name'      => __( 'Property', 'agentpress-listings' ),
					'add_new'            => __( 'Add New', 'agentpress-listings' ),
					'add_new_item'       => __( 'Add New Property', 'agentpress-listings' ),
					'edit'               => __( 'Edit', 'agentpress-listings' ),
					'edit_item'          => __( 'Edit Property', 'agentpress-listings' ),
					'new_item'           => __( 'New Property', 'agentpress-listings' ),
					'view'               => __( 'View Property', 'agentpress-listings' ),
					'view_item'          => __( 'View Property', 'agentpress-listings' ),
					'search_items'       => __( 'Search Properties', 'agentpress-listings' ),
